...
from analyze_thin_content import analyze_thin_content, calculate_thin_content_score_and_details, clean_and_split, classify_content_level
...
async def analyze_thin_content_endpoint(request: Request):
    try:
        ...
        analysis_results = await analyze_thin_content(thin_request)  # Llama a la función directamente
