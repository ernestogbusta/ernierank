...
async def analyze_wpo(url: str = Query(..., description="URL del sitio web para analizar el WPO")):
    try:
        # Comando para ejecutar Lighthouse y guardar el resultado como JSON
        ...
        # Convertir la salida de Lighthouse desde JSON a un objeto Python
